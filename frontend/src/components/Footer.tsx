          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/services#retail-sales" className="text-gray-400 hover:text-white transition-colors">Sales Associate</a></li>
                <li><a href="/services#teaching-tutoring" className="text-gray-400 hover:text-white transition-colors">Tutoring</a></li>
                <li><a href="/services#delivery-logistics" className="text-gray-400 hover:text-white transition-colors">Food Delivery</a></li>
                <li><a href="/services#administrative-office" className="text-gray-400 hover:text-white transition-colors">Data Entry</a></li>
                <li><a href="/services#customer-service" className="text-gray-400 hover:text-white transition-colors">Customer Service</a></li>
                <li><a href="/services#child-pet-care" className="text-gray-400 hover:text-white transition-colors">Childcare</a></li>
              </ul>
            </div>
